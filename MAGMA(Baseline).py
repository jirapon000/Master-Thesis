...
#
#  PER TURN
#  Q agent   → fixed order I1→I8, all 8 domains always asked
#              no skipping — PMI/MIRT used for evidence tracking only
...
#  Clarify   → NLI (vagueness/relevance) + GPT (timeframe only)
#  Align     → NLI history check + .corr() statistical check
...
# =============================================================================
#  BASELINE: MAGMA Multi-Agent (Fixed Order, No Adaptive Skipping)
#  - Fixed question order I1→I8, all 8 domains always asked
#  - PMI/MIRT used for evidence tracking and correlation propagation only
...
# =============================================================================
def compute_phq8_score_transcript(conversation_history: List[Dict]):
    """
